...
describe('Binary Search', () => {
  ...
  test('finds a value in different positions of an even lengthy array', () => {
    expect(find([1,2,3,4], 1)).toEqual(0);
    expect(find([1,2,3,4], 2)).toEqual(1);
    expect(find([1,2,3,4], 3)).toEqual(2);
    expect(find([1,2,3,4], 4)).toEqual(3);
  });

  test('finds a value in different positions of an odd lengthy array', () => {
    expect(find([1,2,3,4,5], 1)).toEqual(0);
    expect(find([1,2,3,4,5], 2)).toEqual(1);
    expect(find([1,2,3,4,5], 3)).toEqual(2);
    expect(find([1,2,3,4,5], 4)).toEqual(3);
    expect(find([1,2,3,4,5], 5)).toEqual(4);
  });
