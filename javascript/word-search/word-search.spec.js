...
describe('single line grids', () => {
  ...
  test('can locate a left to right word in the end position', () => {
    const grid = ['mtrclojure'];
    const expectedResults = {
      clojure: {
        start: [1, 4],
        end: [1, 10],
  ...
  test('can locate that different left to right word in the end', () => {
    const grid = ['xzlpcoffee'];
    const expectedResults = {
      coffee: {
        start: [1, 5],
        end: [1, 10],
